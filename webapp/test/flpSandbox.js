		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Produto Consultas",
									"targetURL": "#produtoconsulta-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"produtoconsulta-display": {
								"semanticObject": "produtoconsulta",
								"action": "display",
								"description": "Produto Consultas",
								"title": "Produto Consultas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=produtoconsulta",
									"url": sap.ui.require.toUrl("produtoconsulta")
								}
							}
						}
					}
